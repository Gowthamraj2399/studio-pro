...
const DeletePhotoModalInner: React.FC<DeletePhotoModalProps> = ({
  photo,
  onConfirm,
  onCancel,
}) => (
  ...
  >
    ...
    >
      ...
      <p
        className="text-slate-600 dark:text-gray-400 text-sm mb-6 truncate"
...
export const DeletePhotoModal = memo(DeletePhotoModalInner);
